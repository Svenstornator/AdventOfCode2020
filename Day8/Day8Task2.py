...
for individualCommand in range(len(command)):
    # print("Iteration " + str(individualCommand))
    if command[individualCommand] == 'jmp':
        command[individualCommand] = 'nop'
    elif command[individualCommand] == 'nop':
        command[individualCommand] = 'jmp'
